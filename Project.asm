...
MEM1 BYTE "Sameera Sajid (21k-3318)",0
MEM2 BYTE "Taha Shah (21k-4930)",0
MEM3 BYTE "Muhammad Amad(21k-3308)",0
var BYTE 15
S1 BYTE "________",0
S2 BYTE "|",0
S3 BYTE "@",0
...
ARRAY7 BYTE "JASMINE",0, "OSTRICH",0, "CHAPTER",0,"COMMITTIE",0, "DEPOSIT",0, "HOLIDAY",0, "CALIBER",0, "KITCHEN", 0,"KINGDOM",0, "ACQUIRE", 0
